...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TPIPE = 3,                      /* TPIPE  */
  YYSYMBOL_EOL = 4,                        /* EOL  */
  YYSYMBOL_SEMICOLON = 5,                  /* SEMICOLON  */
  YYSYMBOL_RD_IN = 6,                      /* RD_IN  */
  YYSYMBOL_RD_OUT = 7,                     /* RD_OUT  */
  YYSYMBOL_RD_TR = 8,                      /* RD_TR  */
  YYSYMBOL_AND_SYM = 9,                    /* AND_SYM  */
  YYSYMBOL_ARG = 10,                       /* ARG  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_input = 12,                     /* input  */
  YYSYMBOL_list = 13,                      /* list  */
  YYSYMBOL_pipeline = 14,                  /* pipeline  */
  YYSYMBOL_task = 15                       /* task  */
};
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined SHELL_STYPE_IS_TRIVIAL && SHELL_STYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TPIPE", "EOL",
  "SEMICOLON", "RD_IN", "RD_OUT", "RD_TR", "AND_SYM", "ARG", "$accept",
  "input", "list", "pipeline", "task", YY_NULLPTR
};
...
{
       0,     2,    11,     0,     0,     6,     5,     1,     3,     0,
       0,     0,     0,     0,     0,     0,    12,     8,     7,     4,
      10,     9,    13,    14,    15
};
...
{
      12,     7,     1,    13,    14,    15,    11,    16,     2,     8,
       9,    19,     2,    17,    10,    13,    14,    15,    22,    16,
      18,     0,    20,    21,    23,    24
};

static const yytype_int8 yycheck[] =
{
       3,     0,     4,     6,     7,     8,     3,    10,    10,     4,
       5,     4,    10,     9,     9,     6,     7,     8,    10,    10,
       9,    -1,    11,    12,    10,    10
};
...
{
       0,     4,    10,    12,    13,    14,    15,     0,     4,     5,
       9,     3,     3,     6,     7,     8,    10,    14,    15,     4,
      15,    15,    10,    10,    10
};
...
#define yyclearin       (yychar = SHELL_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use SHELL_error or SHELL_UNDEF. */
#define YYERRCODE SHELL_UNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = SHELL_EMPTY; /* Cause a token to be read.  */
...
yyerrlab:
  ...
  yytoken = yychar == SHELL_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
